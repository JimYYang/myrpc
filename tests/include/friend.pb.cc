...
class GetFirendsListResponseDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<GetFirendsListResponse> _instance;
} _GetFirendsListResponse_default_instance_;
}  // namespace fixbug
static void InitDefaultsscc_info_GetFirendsListResponse_friend_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_GetFirendsListResponse_default_instance_;
    new (ptr) ::fixbug::GetFirendsListResponse();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::GetFirendsListResponse::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_GetFirendsListResponse_friend_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_GetFirendsListResponse_friend_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_friend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFirendsListResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFirendsListResponse, result_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFirendsListResponse, friends_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::fixbug::ResultCode)},
  { 7, -1, sizeof(::fixbug::GetFriendsListRequest)},
  { 13, -1, sizeof(::fixbug::GetFirendsListResponse)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_GetFirendsListResponse_default_instance_),
};
...
const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "FriendsListRequest\032\036.fixbug.GetFirendsLi"
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_friend_2eproto_sccs[3] = {
  &scc_info_GetFirendsListResponse_friend_2eproto.base,
...
void GetFirendsListResponse::InitAsDefaultInstance() {
  ::fixbug::_GetFirendsListResponse_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
class GetFirendsListResponse::_Internal {
 public:
  static const ::fixbug::ResultCode& result(const GetFirendsListResponse* msg);
};

const ::fixbug::ResultCode&
GetFirendsListResponse::_Internal::result(const GetFirendsListResponse* msg) {
  return *msg->result_;
}
GetFirendsListResponse::GetFirendsListResponse()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:fixbug.GetFirendsListResponse)
}
GetFirendsListResponse::GetFirendsListResponse(const GetFirendsListResponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr),
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.GetFirendsListResponse)
}

void GetFirendsListResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetFirendsListResponse_friend_2eproto.base);
  result_ = nullptr;
}

GetFirendsListResponse::~GetFirendsListResponse() {
  // @@protoc_insertion_point(destructor:fixbug.GetFirendsListResponse)
  SharedDtor();
}

void GetFirendsListResponse::SharedDtor() {
  if (this != internal_default_instance()) delete result_;
}

void GetFirendsListResponse::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const GetFirendsListResponse& GetFirendsListResponse::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFirendsListResponse_friend_2eproto.base);
  return *internal_default_instance();
}


void GetFirendsListResponse::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.GetFirendsListResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetFirendsListResponse::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFirendsListResponse::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.GetFirendsListResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.GetFirendsListResponse)
  return target;
}

size_t GetFirendsListResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFirendsListResponse)
  size_t total_size = 0;
...
void GetFirendsListResponse::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.GetFirendsListResponse)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFirendsListResponse* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFirendsListResponse>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.GetFirendsListResponse)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.GetFirendsListResponse)
    MergeFrom(*source);
  }
}

void GetFirendsListResponse::MergeFrom(const GetFirendsListResponse& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFirendsListResponse)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetFirendsListResponse::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.GetFirendsListResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void GetFirendsListResponse::CopyFrom(const GetFirendsListResponse& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.GetFirendsListResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetFirendsListResponse::IsInitialized() const {
  return true;
}

void GetFirendsListResponse::InternalSwap(GetFirendsListResponse* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata GetFirendsListResponse::GetMetadata() const {
  return GetMetadataStatic();
}
    ...
    case 0:
      GetFriendsList(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::GetFriendsListRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::fixbug::GetFirendsListResponse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& FriendServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::fixbug::GetFirendsListResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFirendsListResponse* Arena::CreateMaybeMessage< ::fixbug::GetFirendsListResponse >(Arena* arena) {
  return Arena::CreateInternal< ::fixbug::GetFirendsListResponse >(arena);
}
