...
namespace fixbug {
class GetFirendsListResponse;
class GetFirendsListResponseDefaultTypeInternal;
extern GetFirendsListResponseDefaultTypeInternal _GetFirendsListResponse_default_instance_;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::fixbug::GetFirendsListResponse* Arena::CreateMaybeMessage<::fixbug::GetFirendsListResponse>(Arena*);
...
class GetFirendsListResponse :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFirendsListResponse) */ {
 public:
  GetFirendsListResponse();
  virtual ~GetFirendsListResponse();

  GetFirendsListResponse(const GetFirendsListResponse& from);
  GetFirendsListResponse(GetFirendsListResponse&& from) noexcept
    : GetFirendsListResponse() {
    *this = ::std::move(from);
  }

  inline GetFirendsListResponse& operator=(const GetFirendsListResponse& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFirendsListResponse& operator=(GetFirendsListResponse&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetFirendsListResponse& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetFirendsListResponse* internal_default_instance() {
    return reinterpret_cast<const GetFirendsListResponse*>(
               &_GetFirendsListResponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(GetFirendsListResponse& a, GetFirendsListResponse& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFirendsListResponse* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline GetFirendsListResponse* New() const final {
    return CreateMaybeMessage<GetFirendsListResponse>(nullptr);
  }

  GetFirendsListResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetFirendsListResponse>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetFirendsListResponse& from);
  void MergeFrom(const GetFirendsListResponse& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFirendsListResponse* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFirendsListResponse";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFirendsListResponse)
 private:
  class _Internal;
...
// .fixbug.ResultCode result = 1;
inline bool GetFirendsListResponse::_internal_has_result() const {
  return this != internal_default_instance() && result_ != nullptr;
}
inline bool GetFirendsListResponse::has_result() const {
  return _internal_has_result();
}
inline void GetFirendsListResponse::clear_result() {
  if (GetArenaNoVirtual() == nullptr && result_ != nullptr) {
    delete result_;
  }
  result_ = nullptr;
}
inline const ::fixbug::ResultCode& GetFirendsListResponse::_internal_result() const {
...
inline const ::fixbug::ResultCode& GetFirendsListResponse::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFirendsListResponse.result)
  return _internal_result();
}
inline ::fixbug::ResultCode* GetFirendsListResponse::release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GetFirendsListResponse.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFirendsListResponse::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* GetFirendsListResponse::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFirendsListResponse.result)
  return _internal_mutable_result();
}
inline void GetFirendsListResponse::set_allocated_result(::fixbug::ResultCode* result) {
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFirendsListResponse.result)
}

// repeated bytes friends = 2;
inline int GetFirendsListResponse::_internal_friends_size() const {
  return friends_.size();
}
inline int GetFirendsListResponse::friends_size() const {
  return _internal_friends_size();
}
inline void GetFirendsListResponse::clear_friends() {
  friends_.Clear();
}
inline std::string* GetFirendsListResponse::add_friends() {
  // @@protoc_insertion_point(field_add_mutable:fixbug.GetFirendsListResponse.friends)
  return _internal_add_friends();
}
inline const std::string& GetFirendsListResponse::_internal_friends(int index) const {
  return friends_.Get(index);
}
inline const std::string& GetFirendsListResponse::friends(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFirendsListResponse.friends)
  return _internal_friends(index);
}
inline std::string* GetFirendsListResponse::mutable_friends(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFirendsListResponse.friends)
  return friends_.Mutable(index);
}
inline void GetFirendsListResponse::set_friends(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:fixbug.GetFirendsListResponse.friends)
  friends_.Mutable(index)->assign(value);
}
inline void GetFirendsListResponse::set_friends(int index, std::string&& value) {
  // @@protoc_insertion_point(field_set:fixbug.GetFirendsListResponse.friends)
  friends_.Mutable(index)->assign(std::move(value));
}
inline void GetFirendsListResponse::set_friends(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  friends_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:fixbug.GetFirendsListResponse.friends)
}
inline void GetFirendsListResponse::set_friends(int index, const void* value, size_t size) {
  friends_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:fixbug.GetFirendsListResponse.friends)
}
inline std::string* GetFirendsListResponse::_internal_add_friends() {
  return friends_.Add();
}
inline void GetFirendsListResponse::add_friends(const std::string& value) {
  friends_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:fixbug.GetFirendsListResponse.friends)
}
inline void GetFirendsListResponse::add_friends(std::string&& value) {
  friends_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:fixbug.GetFirendsListResponse.friends)
}
inline void GetFirendsListResponse::add_friends(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  friends_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:fixbug.GetFirendsListResponse.friends)
}
inline void GetFirendsListResponse::add_friends(const void* value, size_t size) {
  friends_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:fixbug.GetFirendsListResponse.friends)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
GetFirendsListResponse::friends() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFirendsListResponse.friends)
  return friends_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
GetFirendsListResponse::mutable_friends() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFirendsListResponse.friends)
  return &friends_;
}
